...
WHERE ship_via = (SELECT shipper_id FROM shippers WHERE company_name = 'United Package')
...
AND category_id IN
(SELECT category_id FROM categories WHERE category_name IN ('Condiments', 'Dairy Products'))
